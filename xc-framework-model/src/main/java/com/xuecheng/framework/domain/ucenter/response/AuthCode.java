...
public enum AuthCode implements ResultCode {
    ...
    AUTH_LOGIN_APPLYTOKEN_FAIL(false,23007,"登陆失败"),
    AUTH_LOGIN_AUTHSERVER_NOTFOUND(false,23008,"登陆过程认证权限服务未找到"),
    AUTH_LOGIN_TOKEN_SAVEFAIL(false,23009,"登陆过程token保存失败");
