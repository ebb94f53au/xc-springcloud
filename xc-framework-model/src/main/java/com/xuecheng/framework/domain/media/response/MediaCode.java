...
public enum MediaCode implements ResultCode {
    ...
    CHUNK_FILE_NOT_EXIST_CHECK(true,22004,"分块文件在系统不存在！"),
    MERGE_FILE_FAIL(false,22005,"合并文件失败，文件在系统已存在！"),
    UPLOAD_FILE_REGISTER_CREATEFOLDER_FAIL(false,22006,"上传文件，创建文件夹失败！"),
    UPLOAD_FILE_REGISTER_ISNULL(false,22007,"上传文件注册信息为空！"),
    CHUNK_FILE_UPLOAD_FAIL(false,22008,"分块文件上传失败！"),
    MERGE_FILE_CREATEFAIL(false,22009,"分块文件创建失败！"),
